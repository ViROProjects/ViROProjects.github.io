...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_10__["FontAwesomeModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], _page_page_component__WEBPACK_IMPORTED_MODULE_6__["PageComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_7__["ListComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _article_article_component__WEBPACK_IMPORTED_MODULE_9__["ArticleComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_10__["FontAwesomeModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppArticleArticleComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _files_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../files.service */
    "./src/app/files.service.ts");

    var ArticleComponent = /*#__PURE__*/function () {
      function ArticleComponent(filesService) {
      ...
      _createClass(ArticleComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var url = this.folder ? this.folder + "/" + this.page : this.page;
          this.filesService.getArticleContent(url).subscribe(function (x) {
            _this.content = x;
          });
        }
      }]);
    ...
    ArticleComponent.ɵfac = function ArticleComponent_Factory(t) {
      return new (t || ArticleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_files_service__WEBPACK_IMPORTED_MODULE_1__["FilesService"]));
    };
    ...
    ArticleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [[2, "display", "flex", "padding", "15px", "margin", "15px 15px 30px 15px", "background-color", "#FFFFFF", "border-radius", "15px", "border-color", "#E8DDF5", "border-width", "5px", "border-style", "solid"], [2, "flex-grow", "1", 3, "innerHTML"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticleComponent, [{
        ...
        return [{
          type: _files_service__WEBPACK_IMPORTED_MODULE_1__["FilesService"]
        }];
      }, {
        page: [{
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      function DashboardComponent(filesService) {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.filesService.staticPages.subscribe(function (x) {
            _this2.main1 = x.filter(function (xx) {
              return xx.name == 'Main1';
            })[0];
            _this2.main2 = x.filter(function (xx) {
              return xx.name == 'Main2';
            })[0];
            _this2.main3 = x.filter(function (xx) {
              return xx.name == 'Main3';
            })[0];
          });
        }
      }]);
    ...
    DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
      return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_files_service__WEBPACK_IMPORTED_MODULE_1__["FilesService"]));
    };
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 3,
      consts: [[2, "display", "flex", "flex-wrap", "wrap"], ["style", "flex: 1; min-width: 100%;", 4, "ngIf"], ["style", "flex: 1;", 4, "ngIf"], [2, "flex", "1", "min-width", "100%"], [3, "page", "folder"], [2, "flex", "1"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _article_article_component__WEBPACK_IMPORTED_MODULE_3__["ArticleComponent"]],
  ...
  /***/
  function srcAppFilesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var FilesService = /*#__PURE__*/function () {
      function FilesService(http) {
        ...
        this.staticPages = this.masterInfo.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
          return res["static"];
        }));
        this.sections = this.masterInfo.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
          return res.sections;
        }));
      }
      ...
      _createClass(FilesService, [{
        ...
        value: function getArticleContent(area) {
          var _this3 = this;

          return this.masterInfo.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(function (x) {
            var option = {
              responseType: 'text'
            };
            return _this3.http.get(x.baseUrl + "" + area, option);
          }));
        }
      }, {
        key: "getArticlesOnFolder",
        value: function getArticlesOnFolder(folder) {
          return this.sections.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (x) {
            return x.filter(function (xx) {
              return xx.name == folder;
            })[0];
          }));
        }
      }]);
    ...
    FilesService.ɵfac = function FilesService_Factory(t) {
      return new (t || FilesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HeaderComponent = /*#__PURE__*/function () {
      function HeaderComponent(filesService) {
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.filesService.sections.subscribe(function (x) {
            _this4.sections = x;
          });
        }
      }]);
    ...
    HeaderComponent.ɵfac = function HeaderComponent_Factory(t) {
      return new (t || HeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_files_service__WEBPACK_IMPORTED_MODULE_2__["FilesService"]));
    };
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 3,
      consts: [[2, "display", "flex", "background-color", "#E8DDF5", "margin-bottom", "30px"], [2, "flex", "1", "text-align", "center"], [3, "icon"], [2, "flex", "5"], ["routerLink", "/dashboard"], [4, "ngFor", "ngForOf"], [3, "routerLink"]],
      template: function HeaderComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "\xA0ViRO");
      ...
      directives: [_fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FaIconComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"]],
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ListComponent_div_0_button_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_button_1_Template_button_click_0_listener() {
          ...
          return ctx_r3.selectArticle(item_r2);
        });
    ...
    var ListComponent = /*#__PURE__*/function () {
      function ListComponent(filesService) {
      ...
      _createClass(ListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.filesService.getArticlesOnFolder(this.folderName).subscribe(function (x) {
            _this5.folderData = x;
          });
        }
      }, {
        key: "selectArticle",
        value: function selectArticle(item) {
    ...
    ListComponent.ɵfac = function ListComponent_Factory(t) {
      return new (t || ListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_files_service__WEBPACK_IMPORTED_MODULE_1__["FilesService"]));
    };
    ...
    ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["style", "display: flex;flex-direction: column;\npadding: 15px;\nmargin: 15px 15px 30px 15px;\nbackground-color: #FFFFFF;\nborder-radius: 15px;\nborder-color: #E8DDF5;\nborder-width: 5px;\nborder-style: solid;", 4, "ngIf"], [2, "display", "flex", "flex-direction", "column", "padding", "15px", "margin", "15px 15px 30px 15px", "background-color", "#FFFFFF", "border-radius", "15px", "border-color", "#E8DDF5", "border-width", "5px", "border-style", "solid"], [3, "click", 4, "ngFor", "ngForOf"], [3, "click"]],
  ...
  function srcAppPagePageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 2,
      consts: [[2, "display", "flex"], [2, "flex", "1"], [3, "folderName", "myOutput"], [2, "flex", "5"], [4, "ngIf"], [3, "page", "folder"]],
      template: function PageComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("myOutput", function PageComponent_Template_app_list_myOutput_2_listener($event) {
            return ctx.showPage($event);
          });
      ...
      directives: [_list_list_component__WEBPACK_IMPORTED_MODULE_2__["ListComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _article_article_component__WEBPACK_IMPORTED_MODULE_4__["ArticleComponent"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\oscar\Documents\WebDev\AngularGitMain\angular-git-main\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
